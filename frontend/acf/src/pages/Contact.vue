        ...
        >
          ...
          <a-modal v-model="visibleEdit" title="Chỉnh sửa hợp đồng">
            ...
            <a-form-model>
              <a-row type="flex">
                <a-col flex="150px"
                  ><span style="color: red">*</span> <strong> Tên hợp đồng:</strong> 
                </a-col>
                <a-col flex="auto">
                  <a-input
              ...
              <a-row type="flex">
                <a-col flex="150px">
                  <span style="color: red">*</span> <strong> Khách hàng:</strong> 
                </a-col>
                <a-col flex="auto">
                  <a-select
              ...
              <a-row type="flex">
                <a-col flex="150px"
                  ><span style="color: red">*</span> <strong> Hạn hoàn thành: </strong> 
                </a-col>
                <a-col flex="auto">
                  <a-date-picker
